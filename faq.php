...
<body>
  ...
  <nav class="navbar navbar-light bg-light">
    ...
    <nav class="navbar nav justify-content-center">
        <a class="navbar-brand" href="index.php"><img src="img/fyi_logo.png" alt="FYI_TECH" width= "200px"></a>
    </nav>
</div>
<div class="container">
    <h1>FAQ</h1>
        ...
        <div class="accordion" id="accordionExample">
            <div class="card">
              ...
              <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                <div class="card-body">
                  Web kami memberikan informasi tentang ulasan laptop, harga laptop terbaruspesifikasi laptop berita tentang teknologi dan tips juga trik seputar laptop.
                </div>
              </div>
            </div>
            <div class="card">
              <div class="card-header" id="headingTwo">
                <h2 class="mb-0">
                  <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                    Harga yang tertera pada website ini apakah akurat? #2
                  </button>
                </h2>
              </div>
              <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                <div class="card-body">
                 Kami mengambil harga dari online shop seperti, salah satunya adalah tokopedia dan masih banyak lagi.
                </div>
              </div>
            </div>
            <div class="card">
              <div class="card-header" id="headingThree">
                <h2 class="mb-0">
                  <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                    apakah tersedia tempat diskusi di website ini? #3
                  </button>
                </h2>
              </div>
              <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                <div class="card-body">
                  kami menyediakan form diskusi untuk para pengunjung web kami. silahkan kilk form diskusi pada navbar diatas
                </div>
              </div>
            </div>
          </div>
