            ...
            <div class="row">
                <div class="col-lg-6">
					...
					<div class="row">
						...
						<div class="col-lg-8">
							<ul class="list-group list-group-flush">
								<li class="list-group-item"><?= $_GET["cpu"]; ?></li>
								<li class="list-group-item">RAM</li>
								<li class="list-group-item"><?= $_GET["vga"]; ?></li>
								<li class="list-group-item"><?= $_GET["layar"]; ?></li>
							</ul>							
						</div>
					</div>
					<p>
					...
					<div class="collapse" id="collapseExample">
						...
						Ultrabook merupakan laptop dengan dimensi yang tipis yang dapat mendukung mobilitas penggunanya.
						Ultrabook saat ini memang tengah menjadi salah satu produk populer dan memiliki banyak peminat. 
						Selain ukurannya yang tidak terlalu besar dan dimensi yang tipis, ultrabook juga memiliki kinerja yang tinggi. 
						Laptop jenis tersebut identik dengan sebuah laptop kelas premium yang dibanderol dengan harga cukup tinggi. 
						Akan tetapi, berbeda dengan ultrabook kebanyakan, Acer memperkenalkan varian ultrabook yang dijual dengan harga relatif terjangkau melalui Acer Swift 3 SF314-54G.
						Harga Acer Swift 3 SF314-54G diklaim sebagai ultrabook termurah di Indonesia.
						</div>
					</div>						
                </div>
