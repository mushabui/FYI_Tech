...
<div class="container border">
    <nav class="navbar nav justify-content-center">
        <span class="navbar-brand mb-0 h1">Forum Diskusi</span>
    </nav> 
    <div class="container">
        <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="Cari Diskusi" aria-label="Cari Diskusi" aria-describedby="button-addon2">
    ...
    <div class="container">
        <nav class="navbar">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Buat Diskusi Baru</button>
        ...
        <form class="form-inline">
            <div class="input-group mb-3">
                ...
                <div class="input-group-append">
                  <label class="input-group-text" for="inputGroupSelect02">Urutkan</label>
                </div>
              </div>
        </form>
        </nav>
